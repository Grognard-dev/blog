...
<tr>
    ...
    <td class="flex-initial text-black-700 text-center  px-4 py-2 m-2">
        <a class="shadow bg-green-400 hover:bg-green-600 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded m-4" href="editer_article.php?ID=<?=urlencode($Article->id_article)?>">modifier</a></td>
    <td>
     <form method="post">
