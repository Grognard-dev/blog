...
<tr>
    ...
    <td>
         <form method="post">
        <button class=" flex shadow bg-red-400 hover:bg-red-600 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded m-4" type="submit" name="archiver" value="<?= e($Article->id_article)?>">Archiver</button>
        </form>
    </td>
    <td>
